...
game_config_sets.append([2,     2,      3600,    3700,    3800,    3900,    10,    30,     False,      1,     False])
...
########################################
# id >= 100000 are offical competition
...
#                        id,    env_id, agent_s, agent_e, agent_n, agent_w, batch, games,   keep_batch, demos, flag_4in1
game_config_sets.append([100000,	0,	0,		1,		0,		1,		50,	0,	False,	10000,	False])
game_config_sets.append([100001,	0,	0,		2,		0,		2,		50,	0,	False,	10000,	False])
game_config_sets.append([100002,	0,	0,		3,		0,		3,		50,	0,	False,	10000,	False])
game_config_sets.append([100003,	0,	0,		4,		0,		4,		50,	0,	False,	10000,	False])
game_config_sets.append([100004,	0,	0,		5,		0,		5,		50,	0,	False,	10000,	False])
game_config_sets.append([100005,	0,	0,		6,		0,		6,		50,	0,	False,	10000,	False])
game_config_sets.append([100006,	0,	0,		7,		0,		7,		50,	0,	False,	10000,	False])
game_config_sets.append([100007,	0,	0,		8,		0,		8,		50,	0,	False,	10000,	False])
game_config_sets.append([100008,	0,	0,		9,		0,		9,		50,	0,	False,	10000,	False])
game_config_sets.append([100009,	0,	0,		10,		0,		10,		50,	0,	False,	10000,	False])
game_config_sets.append([100010,	0,	0,		11,		0,		11,		50,	0,	False,	10000,	False])
game_config_sets.append([100011,	0,	0,		12,		0,		12,		50,	0,	False,	10000,	False])
game_config_sets.append([100012,	0,	0,		13,		0,		13,		50,	0,	False,	10000,	False])
game_config_sets.append([100013,	0,	0,		14,		0,		14,		50,	0,	False,	10000,	False])
game_config_sets.append([100014,	0,	0,		15,		0,		15,		50,	0,	False,	10000,	False])
game_config_sets.append([100015,	0,	0,		16,		0,		16,		50,	0,	False,	10000,	False])
game_config_sets.append([100016,	0,	0,		17,		0,		17,		50,	0,	False,	10000,	False])
game_config_sets.append([100017,	0,	0,		100,		0,		100,		50,	0,	False,	10000,	False])
game_config_sets.append([100018,	0,	0,		101,		0,		101,		50,	0,	False,	10000,	False])
game_config_sets.append([100019,	0,	0,		102,		0,		102,		50,	0,	False,	10000,	False])
game_config_sets.append([100020,	0,	0,		103,		0,		103,		50,	0,	False,	10000,	False])
game_config_sets.append([100021,	0,	0,		104,		0,		104,		50,	0,	False,	10000,	False])
game_config_sets.append([100022,	0,	0,		105,		0,		105,		50,	0,	False,	10000,	False])
game_config_sets.append([100023,	0,	0,		106,		0,		106,		50,	0,	False,	10000,	False])
game_config_sets.append([100024,	0,	0,		107,		0,		107,		50,	0,	False,	10000,	False])
game_config_sets.append([100025,	0,	0,		108,		0,		108,		50,	0,	False,	10000,	False])
game_config_sets.append([100026,	0,	0,		109,		0,		109,		50,	0,	False,	10000,	False])
game_config_sets.append([100027,	0,	0,		110,		0,		110,		50,	0,	False,	10000,	False])
game_config_sets.append([100028,	0,	0,		111,		0,		111,		50,	0,	False,	10000,	False])
game_config_sets.append([100029,	0,	0,		200,		0,		200,		50,	0,	False,	10000,	False])
game_config_sets.append([100030,	0,	0,		201,		0,		201,		50,	0,	False,	10000,	False])
game_config_sets.append([100031,	0,	0,		202,		0,		202,		50,	0,	False,	10000,	False])
game_config_sets.append([100032,	0,	0,		203,		0,		203,		50,	0,	False,	10000,	False])
game_config_sets.append([100033,	0,	0,		204,		0,		204,		50,	0,	False,	10000,	False])
game_config_sets.append([100034,	0,	0,		205,		0,		205,		50,	0,	False,	10000,	False])
game_config_sets.append([100035,	0,	0,		206,		0,		206,		50,	0,	False,	10000,	False])
game_config_sets.append([100036,	0,	0,		207,		0,		207,		50,	0,	False,	10000,	False])
game_config_sets.append([100037,	0,	0,		208,		0,		208,		50,	0,	False,	10000,	False])
game_config_sets.append([100038,	0,	0,		209,		0,		209,		50,	0,	False,	10000,	False])
game_config_sets.append([100039,	0,	0,		210,		0,		210,		50,	0,	False,	10000,	False])
game_config_sets.append([100040,	0,	0,		211,		0,		211,		50,	0,	False,	10000,	False])
game_config_sets.append([100041,	0,	0,		212,		0,		212,		50,	0,	False,	10000,	False])
game_config_sets.append([100042,	0,	0,		213,		0,		213,		50,	0,	False,	10000,	False])
game_config_sets.append([100043,	0,	0,		214,		0,		214,		50,	0,	False,	10000,	False])
game_config_sets.append([100044,	0,	0,		215,		0,		215,		50,	0,	False,	10000,	False])
game_config_sets.append([100045,	0,	0,		216,		0,		216,		50,	0,	False,	10000,	False])
game_config_sets.append([100046,	0,	0,		217,		0,		217,		50,	0,	False,	10000,	False])
game_config_sets.append([100047,	0,	0,		300,		0,		300,		50,	0,	False,	10000,	False])
game_config_sets.append([100048,	0,	0,		301,		0,		301,		50,	0,	False,	10000,	False])
game_config_sets.append([100049,	0,	0,		302,		0,		302,		50,	0,	False,	10000,	False])
game_config_sets.append([100050,	0,	0,		303,		0,		303,		50,	0,	False,	10000,	False])
game_config_sets.append([100051,	0,	0,		304,		0,		304,		50,	0,	False,	10000,	False])
game_config_sets.append([100052,	0,	0,		305,		0,		305,		50,	0,	False,	10000,	False])
game_config_sets.append([100053,	0,	0,		306,		0,		306,		50,	0,	False,	10000,	False])
game_config_sets.append([100054,	0,	0,		307,		0,		307,		50,	0,	False,	10000,	False])
game_config_sets.append([100055,	0,	0,		308,		0,		308,		50,	0,	False,	10000,	False])
game_config_sets.append([100056,	0,	0,		309,		0,		309,		50,	0,	False,	10000,	False])
game_config_sets.append([100057,	0,	0,		310,		0,		310,		50,	0,	False,	10000,	False])
game_config_sets.append([100058,	0,	0,		311,		0,		311,		50,	0,	False,	10000,	False])
game_config_sets.append([100059,	0,	0,		312,		0,		312,		50,	0,	False,	10000,	False])
game_config_sets.append([100060,	0,	0,		313,		0,		313,		50,	0,	False,	10000,	False])
game_config_sets.append([100061,	0,	0,		314,		0,		314,		50,	0,	False,	10000,	False])
game_config_sets.append([100062,	0,	0,		315,		0,		315,		50,	0,	False,	10000,	False])
game_config_sets.append([100063,	0,	0,		316,		0,		316,		50,	0,	False,	10000,	False])
game_config_sets.append([100064,	0,	0,		317,		0,		317,		50,	0,	False,	10000,	False])
game_config_sets.append([100065,	0,	0,		400,		0,		400,		50,	0,	False,	10000,	False])
game_config_sets.append([100066,	0,	0,		401,		0,		401,		50,	0,	False,	10000,	False])
game_config_sets.append([100067,	0,	0,		402,		0,		402,		50,	0,	False,	10000,	False])
game_config_sets.append([100068,	0,	0,		403,		0,		403,		50,	0,	False,	10000,	False])
game_config_sets.append([100069,	0,	0,		404,		0,		404,		50,	0,	False,	10000,	False])
game_config_sets.append([100070,	0,	0,		405,		0,		405,		50,	0,	False,	10000,	False])
game_config_sets.append([100071,	0,	0,		406,		0,		406,		50,	0,	False,	10000,	False])
game_config_sets.append([100072,	0,	0,		407,		0,		407,		50,	0,	False,	10000,	False])
game_config_sets.append([100073,	0,	0,		408,		0,		408,		50,	0,	False,	10000,	False])
game_config_sets.append([100074,	0,	0,		409,		0,		409,		50,	0,	False,	10000,	False])
game_config_sets.append([100075,	0,	0,		410,		0,		410,		50,	0,	False,	10000,	False])
game_config_sets.append([100076,	0,	0,		411,		0,		411,		50,	0,	False,	10000,	False])
game_config_sets.append([100077,	0,	0,		500,		0,		500,		50,	0,	False,	10000,	False])
game_config_sets.append([100078,	0,	0,		501,		0,		501,		50,	0,	False,	10000,	False])
game_config_sets.append([100079,	0,	0,		502,		0,		502,		50,	0,	False,	10000,	False])
game_config_sets.append([100080,	0,	0,		503,		0,		503,		50,	0,	False,	10000,	False])
game_config_sets.append([100081,	0,	0,		504,		0,		504,		50,	0,	False,	10000,	False])
game_config_sets.append([100082,	0,	0,		505,		0,		505,		50,	0,	False,	10000,	False])
game_config_sets.append([100083,	0,	0,		506,		0,		506,		50,	0,	False,	10000,	False])
game_config_sets.append([100084,	0,	0,		507,		0,		507,		50,	0,	False,	10000,	False])
game_config_sets.append([100085,	0,	0,		508,		0,		508,		50,	0,	False,	10000,	False])
game_config_sets.append([100086,	0,	0,		509,		0,		509,		50,	0,	False,	10000,	False])
game_config_sets.append([100087,	0,	0,		510,		0,		510,		50,	0,	False,	10000,	False])
game_config_sets.append([100088,	0,	0,		511,		0,		511,		50,	0,	False,	10000,	False])
game_config_sets.append([100089,	0,	1,		2,		1,		2,		50,	0,	False,	10000,	False])
game_config_sets.append([100090,	0,	1,		3,		1,		3,		50,	0,	False,	10000,	False])
game_config_sets.append([100091,	0,	1,		4,		1,		4,		50,	0,	False,	10000,	False])
game_config_sets.append([100092,	0,	1,		5,		1,		5,		50,	0,	False,	10000,	False])
game_config_sets.append([100093,	0,	1,		6,		1,		6,		50,	0,	False,	10000,	False])
game_config_sets.append([100094,	0,	1,		7,		1,		7,		50,	0,	False,	10000,	False])
game_config_sets.append([100095,	0,	1,		8,		1,		8,		50,	0,	False,	10000,	False])
game_config_sets.append([100096,	0,	1,		9,		1,		9,		50,	0,	False,	10000,	False])
game_config_sets.append([100097,	0,	1,		10,		1,		10,		50,	0,	False,	10000,	False])
game_config_sets.append([100098,	0,	1,		11,		1,		11,		50,	0,	False,	10000,	False])
game_config_sets.append([100099,	0,	1,		12,		1,		12,		50,	0,	False,	10000,	False])
game_config_sets.append([100100,	0,	1,		13,		1,		13,		50,	0,	False,	10000,	False])
